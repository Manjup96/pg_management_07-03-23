...
//  $bed_detailsGETQuery = 
//  " SELECT id,building_name,manager_email,floor_no,room_no,bed_no,tenant_name,tenant_mobile,complaint_description,complaint_type,resolve_date,comments,DATE_FORMAT(`created_date`, '%d-%m-%Y') as Date from complaints 
//  where manager_email='$manager_email' and building_name='$building_name' and tenant_mobile='$tenant_mobile' ORDER by id DESC ";
 ...
 $bed_detailsGETQuery = 
 " SELECT id,building_name,manager_email,floor_no,room_no,bed_no,tenant_name,tenant_mobile,complaint_description,complaint_type,response,comments,DATE_FORMAT(`created_date`, '%d-%m-%Y') as Date,DATE_FORMAT(`resolve_date`, '%d-%m-%Y') as resolve_date from complaints 
