...
$result=false;
   ...
   $pg_manager_email="ssy.balu@gmail.com";
...
{ 
	...
	//	if(mail($to1,$subject1,$message1,$headers1,'-fssy.balu@gmail.com'))
		{  
		  
                        $to=$tenant_email;
                        $subject="Greetings from PG Managaemnet!!!";
                        $from=$pg_manager_email;
                ...
                <td width="35">&nbsp;</td>
                        ...
                        $headers .= "From: PG Managaemnet <".$pg_manager_email.">"."\r\n";
                        $headers .= "Content-type: text/html; charset=utf8\r\n ";
                    
                            if(mail($to,$subject,$message,$headers,'-fssy.balu@gmail.com'))
                            {
