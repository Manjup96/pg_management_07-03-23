...
$bed_detailsGETQuery = "
select MONTHNAME(date) as Month,year(date) as Year,sum(expenditure_amount) 
as Expenditure from `accounts` group by year(date),month(date) order by year(date) desc;
";  
