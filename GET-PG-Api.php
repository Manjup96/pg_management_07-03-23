...
$bed_detailsGETQuery = "SELECT `id`, `PG_Name`, `manager_mobile`, `manager_email`, `landmark`, `city`, `pincode`, `state`, `address`, `PG_Type`
 from  `create_PG`
where manager_email='$manager_email'  ORDER by id DESC "; 
...
//`id`, `PG_Name`, `manager_mobile`, `manager_email`, `landmark`, `city`, `pincode`, `state`, `address`, `PG_Type`
