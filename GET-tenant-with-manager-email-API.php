...
$bed_detailsGETQuery = "SELECT id,building_name,manager_email,manager_mobile_no,tenant_name,tenant_email,tenant_mobile,tenant_aadhar_number,tenant_address,comments,DATE_FORMAT(`joining_date`, '%d-%m-%Y') as joining_date from tenant_registration_manager_email ORDER by id DESC";
