...
//
    ...
    $DecodedData=json_decode($EncodedData,true);
        ...
        $manager_mobile_no=$DecodedData['manager_mobile_no'];
...
$timestamp = strtotime($joining_date);
 ...
 $result_email=mysqli_query($conn,"select * from tenant_registration_manager_email where tenant_email ='$tenant_email'");

  $result_mobile=mysqli_query($conn,"select * from tenant_registration_manager_email where tenant_mobile ='$tenant_mobile'");
  
  $result_aadhaar=mysqli_query($conn,"select * from tenant_registration_manager_email where tenant_aadhar_number ='$tenant_aadhar_number'");
    ...
    else
{
  ...
  $sql = "insert into `tenant_registration_manager_email`(id,building_name,manager_email,manager_mobile_no,tenant_name,tenant_email,tenant_mobile,tenant_aadhar_number,comments,joining_date,password,tenant_address)
   values('$id','$building_name','$manager_email','$manager_mobile_no','$tenant_name','$tenant_email','$tenant_mobile','$tenant_aadhar_number','$comments','$joining_date','$password','$tenant_address')";
